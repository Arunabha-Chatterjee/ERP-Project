    ...
    return (
        <div className='h-auto w-full'>
            <div className='w-full py-2.5 pl-3'>
                <div className='text-lg font-semibold'>285486458</div>
                <div className='text-xs text-gray-400'>54600</div>
            </div>
            ...
            <div className='w-full px-3 flex py-2 border-t border-t-gray-600 border-b border-b-gray-900
                ...
                <button className='hover:text-white cursor-pointer'>Customer</button>
