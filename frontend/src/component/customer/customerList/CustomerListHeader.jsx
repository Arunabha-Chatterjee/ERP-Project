...
const CustomerListHeader = ({setCustomerListSearch }) => {
    ...
    return (
        <div>
            <div className='flex justify-between items-center pr-2'>
                <div className='text-xl w-fit font-semibold py-3 px-3 h-auto '>Customers</div>
                ...
                hover:text-gray-400 active:text-gray-200 cursor-pointer font-bold"
                    onClick={() => navigate("/add-customer")} /></button>
            </div>
